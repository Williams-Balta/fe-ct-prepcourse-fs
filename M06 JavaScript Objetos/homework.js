...
function pasarUsuarioAPremium(objetoMuchosUsuarios) {
   ...
   for (var index = 0; index < objetoMuchosUsuarios.length; index++) {
...
function sumarLikesDeUsuario(objetoUsuario) {
   ...
   var sumaLikes = 0;
   for (var index = 0; index < objetoUsuario['posts'].length; index++) {
      sumaLikes += objetoUsuario.posts[index].likes
   }
   return sumaLikes;    
